...
void mips_memset16(uint16_t* dst, uint16_t value, size_t size);
void mips_memset32(uint32_t* dst, uint32_t value, size_t size);

void sk_memset16(uint16_t dst[], uint16_t value, int count)
{
    mips_memset16(dst, value, count);
}

void sk_memset32(uint32_t dst[], uint32_t value, int count)
{
    mips_memset32(dst, value, count);
}
